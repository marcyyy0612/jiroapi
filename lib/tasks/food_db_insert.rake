...
namespace :food_db_insert do
  task :run => :environment do
    data_list = [
                        ...
                        { name: "一般的な豚", genre: 0, price: 4000, image_url: "http://www.studiodansyaku.com/wp-content/uploads/2013/01/dsc08312-540x359.jpg"},
                        ...
                        { name: "えそ醤油", genre: 0, price: 4000, image_url: "https://yamasa.chikuwa.co.jp/dispimage.php?fs=s&fnu=hy&fna=201610310925351967270742"},
