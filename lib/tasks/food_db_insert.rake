...
namespace :food_db_insert do
  task :run => :environment do
    data_list = [
                        ...
                        { name: "庶民の豚", genre: 2, price: 50000, image_url: "http://oisiso.com/imagess_6/barabo.gif"},
                        { name: "一般の豚", genre: 2, price: 120000, image_url: "http://www.asahi-meat.com/wp-content/uploads/2011/01/14-1.jpg"},
                        ...
                        { name: "一般のもやし", genre: 4, price: 150000, image_url: "https://cdn.amanaimages.com/cen3tzG4fTr7Gtw1PoeRer/01651097421.jpg"},
                        ...
                        { name: "高級な醤油", genre: 5, price: 4000, image_url: "https://yamasa.chikuwa.co.jp/dispimage.php?fs=s&fnu=hy&fna=201610310925351967270742"},
